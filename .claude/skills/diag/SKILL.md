...
### Errors
- `src/diagnosticsExporter.ts:42:5` [ts/2304] — Cannot find name 'foo'

### Warnings
- `src/extension.ts:15:1` [eslint/prefer-const] — Prefer const over let

### Clean
- `src/diagnosticsExporter.ts` — No issues

### No diagnostics available
- `src/test/suite/extension.test.ts` — Extension has not exported diagnostics for this file
```
